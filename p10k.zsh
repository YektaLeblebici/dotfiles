...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=255
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_BACKGROUND=2
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_BACKGROUND=yellow
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHARED_FOREGROUND=black
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHARED_BACKGROUND=purple
